...
pixi add sagemaker-studio-dataengineering-extensions
# for installing globally
pixi global install sagemaker-studio-dataengineering-extensions
```
...
It is possible to list all of the versions of `sagemaker-studio-dataengineering-extensions` available on your platform:
...
```
pixi search sagemaker-studio-dataengineering-extensions --channel conda-forge
```
